package com.fei.chapter2user.service.impl;

import com.fei.chapter2user.dao.UserInfoDao;
import com.fei.chapter2user.dao.UserSmsCodeDao;
...
public class UserServiceImpl implements UserService {
    ...
    public boolean getSmsCode(GetSmsCodeReqVo getSmsCodeReqVo) {
        ...
        System.out.println("!!!SMS code is : " + smsCode);
        //todo 调用短信平台接口
